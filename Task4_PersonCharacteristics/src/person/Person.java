...
public class Person {
	...
	public static Person readInfo(String line) throws Exception {
		...
		Person person = new Person(firstName, middleName, lastName, gender, height, birthDate, country, city,
				municipality, postalCode, street, number, floor, apartmentNo, educationType, institutionName,

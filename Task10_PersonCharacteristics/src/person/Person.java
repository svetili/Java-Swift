...
public class Person {
	...
	public void addEducation(char educationType, String institutionName, LocalDate enrollmentDate,
	...
	public static Person readInfo(String line) throws Exception {
		...
		while (i < perArr.length) {
			...
			person.addEducation(educationType, institutionName, enrollDate, gradDate, finalGrade);
		}
		return person;
	}
